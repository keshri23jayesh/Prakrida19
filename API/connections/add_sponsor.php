<?php
$UploadDirectory	= 'sponsrs/'; //Upload Directory, ends with slash & make sure folder exist
$SuccessRedirect	= '../sponsrs.php'; //Redirect to a URL after success
...
{	
   ...
   if(move_uploaded_file($_FILES['mFile']["tmp_name"], $UploadDirectory . $NewFileName ))
   {
      ...
      $sql = "INSERT INTO file_records(file_name, Name, Post) VALUES ('$NewFileName', '$FileTitle', '$post')";       
